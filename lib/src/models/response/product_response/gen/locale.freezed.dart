...
abstract class $LocaleCopyWith<$Res> {
  ...
  @useResult
  $Res call({@HiveField(0) Km? km, @HiveField(1) En? en});
...
class _$LocaleImpl implements _Locale {
  _$LocaleImpl({@HiveField(0) this.km, @HiveField(1) this.en});
...
abstract class _Locale implements Locale {
  factory _Locale({@HiveField(0) Km? km, @HiveField(1) En? en}) = _$LocaleImpl;
