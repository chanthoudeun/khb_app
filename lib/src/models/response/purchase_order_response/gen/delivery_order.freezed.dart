...
abstract class $DeliveryOrderCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? orderId, int? totalQty});
}
...
class _$DeliveryOrderImpl implements _DeliveryOrder {
  _$DeliveryOrderImpl({this.orderId, this.totalQty});
  ...
  @override
  String toString() {
    return 'DeliveryOrder(orderId: $orderId, totalQty: $totalQty)';
  }
...
abstract class _DeliveryOrder implements DeliveryOrder {
  factory _DeliveryOrder({int? orderId, int? totalQty}) = _$DeliveryOrderImpl;
