...
abstract class $UserResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({@HiveField(0) User? user, @HiveField(1) String? accessToken});
...
class _$UserResponseImpl implements _UserResponse {
  _$UserResponseImpl({@HiveField(0) this.user, @HiveField(1) this.accessToken});
...
abstract class _UserResponse implements UserResponse {
  factory _UserResponse(
      ...
      @HiveField(1) String? accessToken}) = _$UserResponseImpl;
